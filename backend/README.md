...
## Project Structure
    ...
    ├── testaccountapp_dev_23591  # Django project configurations
...
1. Clone this repo and `cd testaccountapp_dev_23591`
...
2. Clone this repo and `cd testaccountapp_dev_23591`
